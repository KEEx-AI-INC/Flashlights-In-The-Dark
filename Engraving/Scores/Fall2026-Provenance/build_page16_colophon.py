#!/usr/bin/env python3
"""Build the standalone page-16 colophon for the Fall 2026 performer score."""
...
OUTPUT = HERE / "FlashlightsInTheDark_Fall2026_Page16_Colophon.pdf"
...
def draw_text(context, text: str, x: float, baseline: float, font: str, size: float, color=INK, tracking=0.0):
...
def draw_centered(context, text: str, baseline: float, font: str, size: float, color=INK, tracking=0.0):
    line = make_line(text, font, size, color, tracking)
...
def build() -> None:
    ...
    metadata = {
        Quartz.kCGPDFContextTitle: "Flashlights in the Dark - Fall 2026 Performer Score - Colophon",
        Quartz.kCGPDFContextAuthor: "Jon D. Nelson",
        Quartz.kCGPDFContextSubject: "Standalone page-16 colophon for the Fall 2026 performer-score edition",
    ...
    # Editorial provenance, stated without claiming that final validation is complete.
    ...
    draw_text(context, "16", 46, 34, "Academico", 9.5)
